...
router.get('/allf',vet.all_C)
router.get('/show_req',vet.show_requsts)
router.get('/show_all_vet',vet.show_all_doc)
router.get('/profile/:id',vet.show_profile_doc)
...
router.get('/show_profile',vet.show_profile_doc_p)
